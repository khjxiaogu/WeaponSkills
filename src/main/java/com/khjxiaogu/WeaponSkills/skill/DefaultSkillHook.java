...
public class DefaultSkillHook implements SkillHook {
	 ...
	 *
	 * @param name the plugin name<br>插件名称
	 */
	 ...
	 * 为玩家添加技能
	 * @param p the player<br>对应玩家
	 * @param skill skill name<br>技能名称
	 * @param level skill level<br>技能等级
	 */
