...
public interface Skill {
	 ...
	 * @param level 等级
	 */
	public void onRightClick(PlayerClickEvent ev, int level);
	 ...
	 * @param level 等级
	 */
	public void onBeDamageByEntity(PlayerBeDamageEvent ev, int level);

	/**
	 * 有此技能的玩家受到伤害时呼叫，被实体攻击时也会呼叫。
	 * called when a player with this skill being damaged,would also called if
	 ...
	 * indicates that this skill has no damage events
	 * 
